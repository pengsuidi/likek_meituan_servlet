...
@WebServlet("/UpdateSocketImage64Servlet")
public class UpdateSocketImage64Servlet extends HttpServlet {
    private String FOLDER = "/root/SocketImg/";
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try{
            ...
            String img64=req.getParameter(Config.REQUEST_PARAMETER_SOCKET_IMAGE64);

            String image64_addr=null;

            String name = "socket:"+"_" + socket_id  + "_" + System.currentTimeMillis();
            ...
            boolean isUpdate = new UserDao().Update_socket_image64(socket_id,image64_addr);

            if (isUpdate) {
                result.setCode(Config.STATUS_SUCCESS);
                result.setMessage("更新socket64成功");
                ...
                result.setMessage("更新socket64失败");
