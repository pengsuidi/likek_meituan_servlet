...
@WebServlet("/GetOrdersFoodServlet")
public class GetOrdersFoodServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            List<OrderInfo> orderInfoList = OrdersDao.selectOrderesFoodList(userid,oid);
