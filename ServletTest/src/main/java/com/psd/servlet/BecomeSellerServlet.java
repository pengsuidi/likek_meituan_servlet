...
import com.psd.entity.SellerInfo;
...
public class BecomeSellerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            SellerInfo sl = new UserDao().JudgeIfSeller(userid);
            {
                if (sl==null)
                {
                    boolean sellerInfo = new UserDao().BecomeSeller(userid);

                    if (sellerInfo == false) {

                        System.err.println("失败!JSON -> " + JSONObject.toJSONString(result));
                        ...
                        System.err.println("成为商家JSON -> " + JSONObject.toJSONString(result));
                    }
