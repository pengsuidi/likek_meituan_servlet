 ...
 * 登陆接口定义类
 */
@WebServlet("/GetShopInfoByName")
public class GetShopInfoByNameServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            //获取参数
            String shopname = req.getParameter(Config.REQUEST_PARAMETER_SHOPNAME);
            ...
            ShopInfoBuy shop = new UserDao().GetShopInfoByName(shopname);
