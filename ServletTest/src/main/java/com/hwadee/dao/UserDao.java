...
UserDao {
    ...
    public boolean updatePayment(String food_name,String food_price,String total_price,String oid,String user_id,String shop_id)
            throws ClassNotFoundException {
        return new JDBCUtil().execute("insert into payment(shop_id,food_name,food_price,total_price,oid,user_id)" +
                " values(?,?,?,?,?,?)",shop_id, food_name,food_price,total_price,oid,user_id);
