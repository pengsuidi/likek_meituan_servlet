...
import com.hwadee.entity.Buyer;
...
@WebServlet("/selectPayPassword")
public class ShowPayPasswordServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try{
           ...
           User buyer = new UserDao().selectPayPassword(Integer.parseInt(uid));
