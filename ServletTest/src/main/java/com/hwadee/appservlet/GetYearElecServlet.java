...
import com.hwadee.entity.SocketDayElec;
import com.hwadee.entity.SocketMonthElec;
 ...
 * 登陆接口定义类
 */
@WebServlet("/GetYearElecServlet")
public class GetYearElecServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            List<SocketMonthElec> List = new UserDao().GetEleMonths(socket_id,year);
